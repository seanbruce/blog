...
I was excited when first time I saw this pattern when reading source code of [react-query](https://tanstack.com/query/v4) and [zustand](https://github.com/pmndrs/zustand). And I thought that I just found a smart way of doing
performance optimization. couldn't be more wrong - find the missing piece when I write my own 'external store'.
...
- In `handleUpdate` callback, if the data change detected, the 'adaptor' should trigger a re-render.
